...
export const testimonials: UsageItem[] = [
  {
    company: 'Gradle',
    logo: '/js/page/index/images/companies/gradle.svg',
    url: 'https://blog.gradle.org/kotlin-meets-gradle',
    text: 'Gradle is introducing Kotlin as a language for writing build scripts',
  },
  {
    company: 'Corda',
    logo: '/js/page/index/images/companies/corda.svg',
  ...
  {
    company: 'Evernote',
    logo: '/js/page/index/images/companies/evernote.svg',
  ...
  {
    company: 'Coursera',
    logo: '/js/page/index/images/companies/coursera.svg',
  ...
  {
    company: 'Spring',
    logo: '/js/page/index/images/companies/spring.svg',
  ...
  {
    company: 'Atlassian',
    logo: '/js/page/index/images/companies/atlassian.svg',
