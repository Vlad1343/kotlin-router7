...
export const cardsData: HeaderCardItem[] = [
  ...
  },
  {
    ...
    link: '#',
    img: '/js/page/index/images/good-for/server-side.svg',
  },
  {
    id: 3,
    title: 'Web Frontend',
    ...
    link: '#',
    img: '/js/page/index/images/good-for/web.svg',
  },
  {
    id: 4,
    title: 'Android',
    ...
    link: '#',
    img: '/js/page/index/images/good-for/android.svg',
  },
];
